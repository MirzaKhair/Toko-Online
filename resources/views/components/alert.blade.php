...
<div class="flex items-start space-x-3 p-4 border rounded-lg {{ $color }}" role="alert">
    ...
    @if($dismissible)
        <button type="button" onclick="this.parentElement.remove()" class="flex-shrink-0 text-current opacity-50 hover:opacity-100">
